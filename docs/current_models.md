...
Four models available via agent-memory on NVIDIA Jetson AGX Thor (128 GB).
...
| **qwen35-opus-distilled** | Dense | 27B | TBD | 131K/slot × 2 | Distilled reasoning, strong tool use |
...
| qwen35-opus-distilled | ~15 GiB | ~103 GiB | 2 | 131K |
