...
def _make_orchestrator(
    ...
    mock_loader.restore_all_slots.return_value = 2
...
class TestSwapModelSequence:
    ...
    async def test_full_swap_sequence(self) -> None:
        ...
        # Step 1: Save slots (model-tagged)
        loader.save_all_slots.assert_called_once_with(4, "old-model")
        ...
        # Step 4.5: Restore slots for new model
        loader.restore_all_slots.assert_called_once_with(4, "new-model")
