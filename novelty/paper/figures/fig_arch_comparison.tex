...
% Key differences annotations (below disk)
\node[font=\tiny, align=left, text=blue!70!black, anchor=north west] at (-4.5, -2.2) {
    Gemma challenges:\\
...
\node[font=\tiny, align=left, text=red!70!black, anchor=north east] at (4.5, -2.2) {
    DeepSeek challenges:\\
