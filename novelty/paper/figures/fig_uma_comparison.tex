...
\draw[pcie] (host_mem) -- node[right, font=\small, align=center] {PCIe\\transfer} (gpu_mem);
...
\draw[zerocopy] (uma_mem.south) -- node[right, font=\small, text=green!70!black, align=center] {Zero-copy\\access} (cpu_gpu);
