...
% Annotations - positioned above bars with better spacing
\node[font=\footnotesize, text=red] at (axis cs:User A,10.5) {4\% penalty};
\node[font=\footnotesize, text=green!70!black] at (axis cs:User B,27) {2.6$\times$ faster};
\node[font=\footnotesize, text=green!70!black] at (axis cs:Total,35) {1.86$\times$ total};
