...
Information-retrieval workflows route queries to domain-expert agents. We design a Wikipedia routing benchmark with 10 expert agents, each primed with a 2--4K token article on a statistics topic (Bayesian inference, regression analysis, hypothesis testing, etc.).
