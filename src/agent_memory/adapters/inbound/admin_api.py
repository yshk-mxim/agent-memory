...
async def offload_model(
    ...
    try:
        ...
        if engine:
            ...
            engine.shutdown()
            request.app.state.agent_memory.batch_engine = None
...
async def clear_all_caches(
    ...
    try:
        ...
        semantic = request.app.state.agent_memory
