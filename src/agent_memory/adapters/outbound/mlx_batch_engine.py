...
"""MLX block-pool batch inference engine (adapter layer).

Moved from application/batch_engine.py — this module contains MLX-specific
code (14+ deferred mlx.core imports) and belongs in the adapter layer per
...
if TYPE_CHECKING:
    from agent_memory.domain.entities import AgentBlocks as AgentBlocksType
...
from agent_memory.domain.services import BlockPool, mlx_io_lock
from agent_memory.domain.value_objects import CompletedGeneration, ModelCacheSpec, StepOneResult
